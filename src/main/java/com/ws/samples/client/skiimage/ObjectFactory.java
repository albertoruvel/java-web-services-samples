...
package com.ws.samples.client.skiimage;
 ...
 * generated in the com.ws.samples.client.skiimage package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetImageResponse_QNAME = new QName("http://sib.samples.ws.com/", "getImageResponse");
    private final static QName _GetImage_QNAME = new QName("http://sib.samples.ws.com/", "getImage");
    private final static QName _GetImages_QNAME = new QName("http://sib.samples.ws.com/", "getImages");
    private final static QName _GetImagesResponse_QNAME = new QName("http://sib.samples.ws.com/", "getImagesResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ws.samples.client.skiimage
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sib.samples.ws.com/", name = "getImageResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sib.samples.ws.com/", name = "getImage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sib.samples.ws.com/", name = "getImages")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sib.samples.ws.com/", name = "getImagesResponse")

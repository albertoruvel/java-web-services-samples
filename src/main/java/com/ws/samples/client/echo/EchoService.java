 ...
 * 
 */
@WebServiceClient(name = "EchoService", targetNamespace = "http://sib.samples.ws.com/", wsdlLocation = "http://localhost:8080/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECHOSERVICE_QNAME = new QName("http://sib.samples.ws.com/", "EchoService");
    ...
    public Echo getEchoPort() {
        return super.getPort(new QName("http://sib.samples.ws.com/", "EchoPort"), Echo.class);
    }
    ...
    public Echo getEchoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sib.samples.ws.com/", "EchoPort"), Echo.class, features);
    }

 ...
 * 
 */
@WebServiceClient(name = "TimeServerImplService", targetNamespace = "http://sib.samples.ws.com/", wsdlLocation = "http://localhost:8080/ts?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TIMESERVERIMPLSERVICE_QNAME = new QName("http://sib.samples.ws.com/", "TimeServerImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ts?wsdl");
    ...
    public TimeServer getTimeServerImplPort() {
        return super.getPort(new QName("http://sib.samples.ws.com/", "TimeServerImplPort"), TimeServer.class);
    }
    ...
    public TimeServer getTimeServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sib.samples.ws.com/", "TimeServerImplPort"), TimeServer.class, features);
    }

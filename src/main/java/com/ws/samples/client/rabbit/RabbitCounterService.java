...
@WebServiceClient(name = "RabbitCounterService", 
        ...
        wsdlLocation = "http://localhost:8080/rc?wsdl")
//@HandlerChain(file = "/WEB-INF/handler-chain.xml") //Annotation to specify a handler-chain xml file 
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/rc?wsdl");
